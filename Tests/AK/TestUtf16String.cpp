...
{
    {
        ...
        EXPECT_EQ(string.length_in_code_units(), 6uz);
        EXPECT_EQ(string.length_in_code_points(), 6uz);
        EXPECT_EQ(string.utf16_view(), u"hello!");
    }
    {
        ...
        EXPECT_EQ(string.length_in_code_units(), 12uz);
        EXPECT_EQ(string.length_in_code_points(), 12uz);
        EXPECT_EQ(string.utf16_view(), u"hello there!");
    }
    {
    ...
    }
    {
        ...
        EXPECT_EQ(string.utf16_view(), u"hello \xd800!");
    }
    {
        ...
        EXPECT_EQ(string.length_in_code_units(), 8uz);
        EXPECT_EQ(string.length_in_code_points(), 8uz);
        EXPECT_EQ(string.utf16_view(), u"hello \xdc00!");
    }
}
...
{
    {
        auto string = Utf16String::from_utf16(u"hello!");
        EXPECT(!string.is_empty());
        EXPECT(string.is_ascii());
        EXPECT(!string.has_long_ascii_storage());
        EXPECT(string.has_short_ascii_storage());
    ...
    {
        auto string = Utf16String::from_utf16(u"hello there!");
        EXPECT(!string.is_empty());
        EXPECT(string.is_ascii());
        EXPECT(string.has_long_ascii_storage());
        EXPECT(!string.has_short_ascii_storage());
    ...
    {
        auto string = Utf16String::from_utf16(u"😀");
        EXPECT(!string.is_empty());
        EXPECT(!string.is_ascii());
        EXPECT(!string.has_long_ascii_storage());
        EXPECT(!string.has_short_ascii_storage());
    ...
    {
        auto string = Utf16String::from_utf16(u"hello \xd800!");
        EXPECT(!string.is_empty());
        EXPECT(!string.is_ascii());
        EXPECT(!string.has_long_ascii_storage());
        EXPECT(!string.has_short_ascii_storage());
    ...
    {
        auto string = Utf16String::from_utf16(u"hello \xdc00!");
        EXPECT(!string.is_empty());
        EXPECT(!string.is_ascii());
        EXPECT(!string.has_long_ascii_storage());
        EXPECT(!string.has_short_ascii_storage());
...
TEST_CASE(equals_ascii)
{
    auto test = [](StringView ascii, Utf16String const& inequal_string) {
        auto string1 = Utf16String::from_utf8(ascii);

        auto string2 = make_copy(string1);
        (void)string2.utf16_view(); // Convert to UTF-16 storage.

        EXPECT_EQ(ascii, string1);
        EXPECT_EQ(string1, ascii);

        EXPECT_EQ(ascii, string2);
        EXPECT_EQ(string2, ascii);

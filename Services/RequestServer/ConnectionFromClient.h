...
private:
    ...
    virtual Messages::RequestServer::StoreCacheAssociatedDataResponse store_cache_associated_data(URL::URL, ByteString method, Vector<HTTP::Header> request_headers, u64 vary_key, HTTP::CacheEntryAssociatedData, Core::AnonymousBuffer) override;

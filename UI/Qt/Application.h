...
private:
    ...
    virtual void update_bookmarks_bar_display(WebView::BookmarksBarDisplayMode) const override;
    virtual bool supports_bookmarks_bar_display_mode(WebView::BookmarksBarDisplayMode) const override { return true; }

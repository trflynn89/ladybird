    ...
    , m_window(window)
{
    ...
    m_page_context_menu = create_application_menu(this, view().page_context_menu(), [this](Gfx::IntPoint position) {
        m_page_context_menu->exec(view().map_point_to_global_position(position));
    });
    m_link_context_menu = create_application_menu(this, view().link_context_menu(), [this](Gfx::IntPoint position) {
        m_link_context_menu->exec(view().map_point_to_global_position(position));
    });
    m_image_context_menu = create_application_menu(this, view().image_context_menu(), [this](Gfx::IntPoint position) {
        m_image_context_menu->exec(view().map_point_to_global_position(position));
    });
    m_media_context_menu = create_application_menu(this, view().media_context_menu(), [this](Gfx::IntPoint position) {
        m_media_context_menu->exec(view().map_point_to_global_position(position));
    });

    m_toolbar->addAction(view().navigate_back_action().ui_action<QAction>());
    m_toolbar->addAction(view().navigate_forward_action().ui_action<QAction>());
    m_toolbar->addAction(view().reload_action().ui_action<QAction>());
    ...
    m_context_menu->addAction(view().reload_action().ui_action<QAction>());
...
{
    refresh_application_action_icon(palette(), view().navigate_back_action());
    refresh_application_action_icon(palette(), view().navigate_forward_action());
    refresh_application_action_icon(palette(), view().reload_action());

    ...
    , m_is_popup_window(is_popup_window)
{
    ...
    edit_menu->addAction(Application::the().copy_selection_action().ui_action<QAction>());
    edit_menu->addAction(Application::the().paste_action().ui_action<QAction>());
    edit_menu->addAction(Application::the().select_all_action().ui_action<QAction>());
    ...
    inspect_menu->addAction(Application::the().view_source_action().ui_action<QAction>());

...
void AccessibilityNodeActor::handle_message(Message const& message)
{
    ...
    if (message.type == "hydrate"sv) {
        ...
        // Find this node's index within its parent.
        ...
        "value": ""
        */
        properties.set("actions"sv, JsonArray {});
        properties.set("attributes"sv, JsonObject {});
        properties.set("description"sv, ""sv);
        ...
        properties.set("states"sv, JsonArray {});

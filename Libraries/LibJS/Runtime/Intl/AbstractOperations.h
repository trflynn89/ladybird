...
using StringOrBoolean = Variant<Utf16View, bool>;
...
JS_API bool is_well_formed_currency_code(Utf16View const& currency);
...
JS_API bool is_well_formed_unit_identifier(Utf16View const& unit_identifier);
...
JS_API ThrowCompletionOr<StringOrBoolean> get_boolean_or_string_number_format_option(VM& vm, Object const& options, PropertyKey const& property, ReadonlySpan<Utf16View> string_values, StringOrBoolean fallback);

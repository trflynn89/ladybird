...
ThrowCompletionOr<GC::Ref<Object>> DisplayNamesConstructor::construct(FunctionObject& new_target)
{
    ...
    display_names->set_style(style.as_string().view());
    ...
    display_names->set_type(type.as_string().view());
    ...
    display_names->set_fallback(fallback.as_string().view());
    ...
    if (display_names->type() == DisplayNames::Type::Language) {
        ...
        display_names->set_language_display(language_display.as_string().view());

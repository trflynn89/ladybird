...
// 13.5.6.1 ValidateDurationUnitStyle ( style, display, prevStyle ), https://tc39.es/ecma402/#sec-validatedurationunitstyle
// AD-HOC: Our implementation takes a couple extra parameters for better exception messages.
static ThrowCompletionOr<void> validate_duration_unit_style(VM& vm, DurationFormat::ValueStyle style, DurationFormat::Display display, Optional<DurationFormat::ValueStyle> previous_style, PropertyKey const& unit_property_key, StringView display_field)
{
...
ThrowCompletionOr<DurationUnitOptions> get_duration_unit_options(VM& vm, DurationFormat::Unit unit, Object const& options, DurationFormat::Style base_style, ReadonlySpan<StringView> styles_list, DurationFormat::ValueStyle digital_base, Optional<DurationFormat::ValueStyle> previous_style, bool two_digit_hours)
{
    ...
    // 7. Perform ? ValidateDurationUnitStyle(style, display, prevStyle).
    TRY(validate_duration_unit_style(vm, style, display, previous_style, unit_property_key, display_field));
